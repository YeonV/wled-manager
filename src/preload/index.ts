...
if (process.contextIsolated) {
  ...
  window.addEventListener('DOMContentLoaded', () => {
    console.log(path.join(__dirname, '../../recources/icon.png'))
    // Title bar implementation
    new Titlebar({
      backgroundColor: TitlebarColor.fromHex('#444'),
      icon: nativeImage.createFromPath(path.join(__dirname, '../../recources/icon.png'))
      ...
      // ),
      // icon: nativeImage.createFromPath(path.join(__dirname, "../images/logo.png")),
    })
  })
}
